...
// le 1er parametre représente la connexion à notre base de données sequelize, le paramètre datatypes permet de définir les types de données
    ...
    "Pokemon",
    {
      ...
      hp: {
        ...
        validate: {
          ...
          max: {
            args: [999],
            msg: "Les points de vie ne peuvent pas exécéder 999.",
          },
        },
      },
      cp: {
        ...
        validate: {
          ...
          min: {
            args: [0],
            msg: "Les points de dégâts ne peuvent pas être inférieus à 0.",
          },
          max: {
            args: [99],
            msg: "Les points de dégâts ne peuvent pas exécéder 999.",
          },
        },
      },
      picture: {
